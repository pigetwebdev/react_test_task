...
import { bindActionCreators } from "redux";
 ...
 const  DEFAULT_QUERY = 'res/res.json'    //API
        ...
        >
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-primary" onClick={() => {this.props.deleteTodo(this.state.selID); this.setState({modalIsOpen: false});}}>Yes</button>
            </div>
          </div>
        </Modal>           
            ...
            <tbody>
              {this.props.todos.map(todo => (
                <tr key={todo.id}>
                  <td width = "10%">
                  <span
                        className={ todo.active? "far fa-check-circle" : "far fa-circle"}
